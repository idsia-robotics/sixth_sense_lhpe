...
plot_info = [
    ...
    vis_utils.make_sensor_range_plot("kinect_range", "blue"),
    vis_utils.make_humans_plot("humans_kinect", "red"),
    vis_utils.make_humans_plot("humans_optitrack", "darkblue"),
